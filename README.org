...
** Definition
This is an example for the [[https://github.com/danielsz/system-dependency-injection][system]] library. It shows how to leverage the dependency injection features of [[https://github.com/stuartsierra/component][componen]]t, the libary on top of which system itself is built. 
** Mission statement
